...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="section1">
        <div class="box11">
           ...
           <div class="line">教学体系发布</div>
            <div class="content">
                基于IMA定义的“管理会计能力素质框架”研发设计的阶梯式CMA教学体系
            </div>
            <div class="btn">
                <a href="http://lwt.zoosnet.net/LR/Chatpre.aspx?id=LWT91490211&lng=cn" target="_blank">点击咨询>></a>
            </div>
        </div>
    </div>
    ...
    <div class="section2">
        ...
        <a href="https://lwt.zoosnet.net/LR/Chatpre.aspx?id=LWT91490211&lng=cn" target="_blank" class="yellowa">获取《管理会计能力素质框架》全文</a>
    </div>
    ...
    <div class="section3">
        ...
        <br />
        <a href="https://lwt.zoosnet.net/LR/Chatpre.aspx?id=LWT91490211&lng=cn" target="_blank" class="yellowa">获取《CMA 6级赋能教学体系》简章</a>
    </div>

    <div class="section4">
        <h4>华领国际师资团队</h4>
        <p>
            华领国际师资星光璀璨、实力雄厚，清华大学、中央财经大学教授、财政部管理会计咨询专家、现任500强企业财务总监、IMA协会高管。华领国际师资屡次被北京国家会计学院、国资委央企CMA班、国际500强企业内训班、IMA主办的CMA师资培训班选定为主讲老师。
        </p>
    </div>
    ...
    <div class="section13">
        <div class="boxheader">
            <span class="p1">LEADING ENTERPRISES</span>
            <span class="p2">跨国跨行业领军企业的选择</span>
            <span class="p3">销售额千亿级企业集团管理会计战略服务平台</span>
        </div>
        <div style="width: 1110px; margin: 0 auto; margin-top: 20px;">
            <div class="container">
                ...
                <div id="context">
                    <span class="b-title" style="color:#eda336;">内训实例体现企业实力，因为专业，所以被认可！</span>
                    ...
                    <a href="http://lwt.zoosnet.net/lr/chatpre.aspx?id=lwt91490211&amp;lng=cn&amp;r=&amp;rf1=&amp;rf2=&amp;p=http%3A//www.hualingedu.com/inner/&amp;cid=1516536987493586880271&amp;sid=1516622867791438453438" target="_blank" class="btn">点击咨询课程顾问</a>
                </div>
            </div>
        </div>
    </div>
